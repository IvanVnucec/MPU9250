...
<b>MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle</b>
...
<b>int begin(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
```C
int status;
status = MPU9250_begin(MPU9250_writeRegister_T MPU9250_writeRegister,
	&MPU9250_readRegisters, 
	&MPU9250_delayMiliSec,
	&MPU9250_Handle);
```

#### Configuration Functions

<b>(optional) int MPU9250_setAccelRange(AccelRange range, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) int MPU9250_setGyroRange(GyroRange_t range, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) int MPU9250_setDlpfBandwidth(DlpfBandwidth_t bandwidth, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) int MPU9250_setSrd(uint8_t srd, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) int MPU9250_enableDataReadyInterrupt(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) int MPU9250_disableDataReadyInterrupt(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) int MPU9250_calibrateGyro(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getGyroBiasX_rads(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getGyroBiasY_rads(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getGyroBiasZ_rads(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) void MPU9250_setGyroBiasX_rads(float bias, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) void MPU9250_setGyroBiasY_rads(float bias, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) void MPU9250_setGyroBiasZ_rads(float bias, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) int MPU9250_calibrateAccel(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getAccelBiasX_mss(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getAccelScaleFactorX(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getAccelBiasY_mss(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getAccelScaleFactorY(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getAccelBiasZ_mss(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float getAccelScaleFactorZ(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) void MPU9250_setAccelCalX(float bias,float scaleFactor, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) void MPU9250_setAccelCalY(float bias,float scaleFactor, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) void MPU9250_setAccelCalZ(float bias,float scaleFactor, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) int MPU9250_calibrateMag(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getMagBiasX_uT(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getMagScaleFactorX(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getMagBiasY_uT(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getMagScaleFactorY(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getMagBiasZ_uT(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) float MPU9250_getMagScaleFactorZ(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) void MPU9250_setMagCalX(float bias,float scaleFactor, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) void MPU9250_setMagCalY(float bias,float scaleFactor, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) void MPU9250_setMagCalZ(float bias,float scaleFactor, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>(optional) int MPU9250_enableWakeOnMotion(float womThresh_mg,LpAccelOdr odr, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>int MPU9250_readSensor(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> reads the sensor and stores the newest data in a buffer, it should be called every time you would like to retrieve data from the sensor. This function returns a positive value on success and a negative value on failure.

```C
MPU9250_readSensor(&MPU9250_Handle);
```

<b>float MPU9250_getAccelX_mss(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the accelerometer value from the data buffer in the X direction and returns it in units of m/s/s.
...
<b>float MPU9250_getAccelY_mss(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the accelerometer value from the data buffer in the Y direction and returns it in units of m/s/s.
...
<b>float MPU9250_getAccelZ_mss(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the accelerometer value from the data buffer in the Z direction and returns it in units of m/s/s.
...
<b>float MPU9250_getGyroX_rads(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the gyroscope value from the data buffer in the X direction and returns it in units of rad/s.
...
<b>float MPU9250_getGyroY_rads(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the gyroscope value from the data buffer in the Y direction and returns it in units of rad/s.
...
<b>float MPU9250_getGyroZ_rads(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the gyroscope value from the data buffer in the Z direction and returns it in units of rad/s.
...
<b>float MPU9250_getMagX_uT(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the magnetometer value from the data buffer in the X direction and returns it in units of uT.
...
<b>float MPU9250_getMagY_uT(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the magnetometer value from the data buffer in the Y direction and returns it in units of uT.
...
<b>float MPU9250_getMagZ_uT(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the magnetometer value from the data buffer in the Z direction and returns it in units of uT.
...
<b>float MPU9250_getTemperature_C(MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the die temperature value from the data buffer and returns it in units of C.
...
### FIFO Setup
<b>(optional) int MPU9250_enableFifo(bool accel,bool gyro,bool mag,bool temp, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b>
...
<b>void MPU9250_getFifoAccelY_mss(size_t *size,float* data, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the accelerometer value from the data buffer in the Y direction and returns it in units of m/s/s. The data is returned as an array along with the number of elements within that array. Ensure that the buffer you are transfering to has enough capacity to store the data.
...
<b>void MPU9250_getFifoAccelZ_mss(size_t *size,float* data, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the accelerometer value from the data buffer in the Z direction and returns it in units of m/s/s. The data is returned as an array along with the number of elements within that array. Ensure that the buffer you are transfering to has enough capacity to store the data.
...
<b>void MPU9250_getFifoGyroX_rads(size_t *size,float* data, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the gyroscope value from the data buffer in the X direction and returns it in units of rad/s. The data is returned as an array along with the number of elements within that array. Ensure that the buffer you are transfering to has enough capacity to store the data.
...
<b>void MPU9250_getFifoGyroY_rads(size_t *size,float* data, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the gyroscope value from the data buffer in the Y direction and returns it in units of rad/s. The data is returned as an array along with the number of elements within that array. Ensure that the buffer you are transfering to has enough capacity to store the data.
...
<b>void MPU9250_getFifoMagX_uT(size_t *size,float* data, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the magnetometer value from the data buffer in the X direction and returns it in units of uT. The data is returned as an array along with the number of elements within that array. Ensure that the buffer you are transfering to has enough capacity to store the data.
...
<b>void MPU9250_getFifoMagY_uT(size_t *size,float* data, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the magnetometer value from the data buffer in the Y direction and returns it in units of uT. The data is returned as an array along with the number of elements within that array. Ensure that the buffer you are transfering to has enough capacity to store the data.
...
<b>void MPU9250_getFifoMagZ_uT(size_t *size,float* data, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the magnetometer value from the data buffer in the Z direction and returns it in units of uT. The data is returned as an array along with the number of elements within that array. Ensure that the buffer you are transfering to has enough capacity to store the data.
...
<b>void MPU9250_getFifoTemperature_C(size_t *size,float* data, MPU9250_Handle_s *MPU9250_Handle *MPU9250_Handle)</b> gets the die temperature value from the data buffer and returns it in units of C. The data is returned as an array along with the number of elements within that array. Ensure that the buffer you are transfering to has enough capacity to store the data.
